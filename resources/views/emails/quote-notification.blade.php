...
<head>
    ...
    <style>
        ...
        .badge { display: inline-block; padding: 4px 12px; background: #a460bf20; color: #a460bf; border-radius: 20px; font-size: 12px; }
    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="field">
                ...
                <div><span class="badge">{{ $service }}</span></div>
            </div>
            <div class="field">
            ...
            <div class="field">
                ...
                <div>{{ $has_branding }}</div>
            </div>
            <div class="field">
                <div class="field-label">Existing Hosting:</div>
                <div>{{ $has_hosting }}</div>
            </div>
            <div class="field">
        ...
        <div class="footer">
            <p>Respond to this quote request within 24 hours.</p>
        </div>
    </div>
</body>
</html>